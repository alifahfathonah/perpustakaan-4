                                ...
                                ?>
                                    <tr>
                                        ...
                                        <td>
                                            <?php
                                                if($row->role == "admin") {
                                                    echo "<span class='btn btn-primary btn-xs'>$row->role</span>";
                                                } else if($row->role == "anggota") {
                                                    echo "<span class='btn btn-success btn-xs'>$row->role</span>";
                                                } else if($row->role == "kepsek") {
                                                    echo "<span class='btn btn-danger btn-xs'>Kepala Sekolah</span>";
                                                }
                                            ?>
                                        </td>
