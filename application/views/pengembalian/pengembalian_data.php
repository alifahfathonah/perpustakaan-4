                ...
                <form class="form-horizontal" action="" method="post">
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-lg-8">
                                <input type="text" name="kode" id="kode_buku" class="form-control" readonly="readonly">
                            </div>
                        </div>
        ...
        if(no_transaksi == "" || nis == ""){
            ...
            //kalau sudah lengkap lakukan insert ke database 
                ...
                $.ajax({
                    ...
                    type:"POST",
                    data:"no_transaksi="+no_transaksi+"&denda="+denda+"&nominal="+nominal+"$kode_buku="+kode_buku,
                    cache:false,
                    success:function(){
