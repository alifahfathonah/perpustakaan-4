                            ...
                            <table width="100%" class="table table-striped table-bordered table-hover" id="dataTables-example">
                                ...
                                ?>
                                    <tr>
                                        ...
                                        <td>
                                            <?php foreach($klasifikasi_data->result() as $data):?>
                                            <?= ($data->id == $row->klasifikasi) ? $data->nama : '';?>
                                            <?php endforeach;?>
                                        </td>
                                      
                                       

                                       <td><?php echo ($row->stock-$this->db->get_where('transaksi',['kode_buku'=> $row->kode_buku])->num_rows()+-$this->db->get_where('pengembalian',['id_transaksi'=> $row->kode_buku])->num_rows());?>
                                       <?php if($this->session->userdata['role'] == "admin") { ?>    
