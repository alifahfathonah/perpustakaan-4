...
<div class="panel panel-default">
    ...
    <div class="panel-body">
        ...
        <div class="row">
            <?php if($this->session->userdata['role'] == "admin" || $this->session->userdata['role'] == "kepsek") { ?>
            <div class="col-lg-4 col-md-6">
                <div class="panel panel-primary">
                    <div class="panel-heading">
                        <div class="row">
                            ...
                            <div class="col-xs-9 text-right">
                                <div class="huge"><?=$this->db->get('anggota')->num_rows();?></div>
                                <div>Anggota!</div>
                            </div>
                        </div>
                    </div>
                    ...
                    <?php } else { ?>
                    <a href="<?php echo base_url('laporan/anggota'); ?>">
                    <?php } ?>
                ...
                <div class="panel panel-green">
                    <div class="panel-heading">
                        <div class="row">
                            ...
                            <div class="col-xs-9 text-right">
                                <div class="huge"><?=$this->db->get('buku')->num_rows();?></div>
                                <div>Buku!</div>
                            </div>
                        </div>
                    </div>
                    <?php if($this->session->userdata['role'] == "admin" || $this->session->userdata['role'] == "anggota") { ?>
                    <a href="<?php echo base_url('buku'); ?>">
                    <?php } else { ?>        
                    <a href="<?php echo base_url('laporan/buku'); ?>">
                    <?php } ?>
                        <div class="panel-footer">
                            <span class="pull-left">View Details</span>
                            <span class="pull-right"><i class="fa fa-arrow-circle-right"></i></span>
